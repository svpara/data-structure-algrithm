class Solution {
 public:
  TreeNode* buildTree(vector<int>& preorder, vector<int>& inorder) {
    ...
    // that can be used of the another method it can be used 
    // that are used the another method of the another leval of grant final tour 
    ...
    return build(preorder, 0, preorder.size() - 1, inorder, 0,
            ...
            // this is set to the size of array 
  }
